        ...
        choices: [
            {
                ...
                value: () => {
                    open("mailto:hi@akashsureshmyd@gmail.com");
            ...
            },
            {
                ...
                value: () => {
                    ...
                    let pipe = request('https://akkupy.github.io/').pipe(fs.createWriteStream('./akku-resume.html'));
                    pipe.on("finish", function () {
                        let downloadPath = path.join(process.cwd(), 'akku-resume.html')
...
const data = {
    ...
    github: chalk.gray("https://github.com/") + chalk.green("akkupy/"),
    linkedin: chalk.gray("https://linkedin.com/in/") + chalk.blue("akkupy/"),
